...
class Laser {
    ...
    // Override effective output PPS without altering GUI parameter (0=disabled)
    void setPpsOverride(int v) { ppsOverride = v; }
    int getEffectivePps() const { return (ppsOverride>0)? ppsOverride : (int)pps.get(); }
